...
export const FileArchive: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 22h2a2 2 0 0 0 2-2V7l-5-5H9a2 2 0 0 0-2 2v5.5"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M4 22V10.5a2.5 2.5 0 0 1 .8-1.7l1.4-1.4a2.5 2.5 0 0 1 3.6 0l1.4 1.4a2.5 2.5 0 0 1 .8 1.7V22"/><path d="M6 15h4"/><path d="M8 12v6"/></svg>
);
...
export const BookText: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
